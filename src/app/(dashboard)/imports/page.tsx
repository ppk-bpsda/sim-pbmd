  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-500">Modul ini akan diimplementasikan penuh pada Phase 8.</p>
      </div>
      <div className="rounded-card border border-dashed border-surface-border bg-white p-8 text-center text-sm text-slate-400 shadow-card">
        Halaman Import Data belum tersedia — dijadwalkan pada Phase 8 sesuai roadmap.
      </div>
    </div>
  );
}
